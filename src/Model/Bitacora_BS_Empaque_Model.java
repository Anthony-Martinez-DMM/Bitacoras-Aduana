 ...
 * @author DMM-ADMIN
 */
public class Bitacora_BS_Empaque_Model {
    
    DBConexion conexion = new DBConexion();
    
    public void consultaYLlenadoDeTablas(Bitacora_BS_Empaque_View reportesVista) {
        ...
        if (fi == null || ff == null) {
            ...
            try {
                ...
                while (rst.next()) {
                    ...
                    if (orden.equals("ASL")) {
                        total = proceRodGuide(rst.getString("orden_manufactura"));
                        int aprob, sob;
    ...
    public void consultaYLlenadoDeTablasByMOG(Bitacora_BS_Empaque_View reportesVista) {
        Connection connectionDB = conexion.conexionBUSHMySQL();
    ...
    public int proceRodGuide(String orden) {
        Connection con = conexion.conexionBUSHMySQL();
        int rg = 0;
        try {
    ...
    public void limpiarTabla(Bitacora_BS_Empaque_View reportesVista){
        DefaultTableModel dtm = new DefaultTableModel();
        reportesVista.jTableReporte.setModel(dtm);
        reportesVista.jTableReporte.setAutoResizeMode(0);
